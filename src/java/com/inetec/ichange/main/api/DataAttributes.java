...
public class DataAttributes extends Properties {
     ...
     * @throws com.inetec.common.exception.Ex 如不能正确返回 ，则返回X异常。
     */
     ...
     *
     * @param in 对象数据流.
     * @throws java.io.IOException 如果读数据流不成功,返回IOException.
     */
     ...
     * @param os 输出数据流.
     * @param s  对象流的头部信息.
     * @throws java.io.IOException 如果写数据流不成功,返回IOException.
     */
     ...
     * @throws java.io.IOException 如果序列化不成功,返回IOException.
     */
     ...
     * @return 数据流对应的二进制数组。
     * @throws java.io.IOException 如果读取不 成功，返回IOException异常。
     */
