...
public interface IDataDisposer {
    ...
    public DataAttributes disposeFile(InputStream is, DataAttributes props, String url)
            throws Ex, IOException;

    public DataAttributes disposeFile(String filename, DataAttributes props, String url)
            throws Ex, IOException;
