...
//        boolean privated = StringUtils.getPrivated();
       ...
       // String pzManager = "TOP_PZGL:SECOND_SJKPZ:SECOND_BJPZ:SECOND_SBPZ:SECOND_SJRB:SECOND_XXAQCL:SECOND_GLPZ:";//配置管理
        ...
        //String yxjkManager = "TOP_YXJK:SECOND_YWYXJK:SECOND_SBYXJK:";                             //运行监控
        String yxjkManager = "TOP_YXJK:SECOND_SBYXJK:";                             //运行监控
       // String xtManager = "TOP_XTGL:SECOND_INIT_S:SECOND_INIT_T:SECOND_PTPZ:SECOND_PTSM:SECOND_PTGL:SECOND_ZSGL:SECOND_RZXZ:SECOND_BBSJ:SECOND_MB_PZHF:SECOND_MB_PZWJGL:SECOND_HFCCSZ:";//内网系统管理
        String xtManager = "TOP_XTGL:SECOND_PTGL:SECOND_RZXZ:SECOND_BBSJ:SECOND_TDPZ:";//内网系统管理
      ...
      //  String nwshManager = "TOP_SHGL:SECOND_MB_WJTBSH:SECOND_MB_DBTBSH:SECOND_MB_TYDLSH:";//内网审核管理
       // String wwshManager = "TOP_SHGL:SECOND_YD_WJTBSH:SECOND_YD_DBTBSH:SECOND_YD_TYDLSH:";//外网审核管理
        String tcpxlMannager ="TOP_XLTDGL:SECOND_TCPS:SECOND_TCPC:";
        String udptdManager ="TOP_SPTDGL:SECOND_UDPS:SECOND_UDPC:";
        String permission = qxManager+wlManager+yxjkManager+xtManager+tcpxlMannager+udptdManager;
        /*if(privated){     //内网
            permission = qxManager + bjManager + sjManager + wlManager + pzManager +
                         nwxtManager + nwsjyManager + nwyyManager + nwshManager + nwjkManager+wwsjyManager;
        } else {      //外网
            permission = qxManager + bjManager + sjManager + wlManager + pzManager +
