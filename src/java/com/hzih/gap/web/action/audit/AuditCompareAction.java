...
import com.hzih.gap.service.AuditService;
...
public class AuditCompareAction extends ActionSupport {
    ...
    public String export() throws IOException{
        ...
        try {
            List<AuditReset> list =  setAuditReset(businessTypes, businessNames, fileNames,fileSizes);
    ...
    private List<AuditReset> setAuditReset(String[] businessTypes, String[] businessNames, String[] fileNames,String[] fileSizes) {
    ...
    public String deleteFile() throws IOException{
        ...
        String msg =  null;
        try {
            File file = new File(StringContext.RESETFILEPATH+"/"+fileName);
            file.delete();
