package com.hzih.gap.web.action.config;
...
//            String sqlPath = request.getRealPath("WEB-INF")+ "/init.sql";
            String sqlPath = request.getContextPath() + "/init.sql";
            //要执行的脚本
...
//        if (osinfo.isWin()) {
//            proc = new Proc();
//            proc.exec("nircmd service restart gap");
//        }
//        if (osinfo.isLinux()) {
//            proc = new Proc();
//            proc.exec("service gap restart");
//        }
        return null;
	}
	...
	public String initConfig() throws Exception {
        ...
        try{
            ...
            if(privated) {//内网
                String dir = StringContext.systemPath + "/tomcat/webapps" +request.getContextPath() + "/data/neiwang/repository";
            ...
            FileUtil.deleteFiles(StringContext.INTERNALVERSIONPATH);
            FileUtil.deleteFiles(StringContext.EXTERNALVERSIONPATH);
            FileUtil.deleteFiles(StringContext.INTERNALHISTORYPATH);
            FileUtil.deleteFiles(StringContext.EXTERNALHISTORYPATH);
