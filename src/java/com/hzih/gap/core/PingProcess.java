...
public class PingProcess {
    ...
    private final static String logPaht = "/root/ixgbe/ixgbe.log";

    private final static String configPath = "/root/ixgbe/ixgbe.txt";

    private static Logger logger = Logger.getLogger(PingProcess.class);
        ...
        if (OSInfo.getOSInfo().isLinux()) {
            ...
            while (true){
                ...
                try {
                    ...
                    String command = " ping -q "+pingIP+" -i 0.0001 -c 10000";

                    String result = pingResult(command);
                    ...
                    for(int i = 0 ; i < strs.length ; i++){
                        ...
                        if(strs[i].contains("packet loss")){
                            ...
                            if(!data.equals("0%")){
                                ...
                                fileOutputStream.write(log.getBytes("gbk"));

                                Thread.sleep(pingTime*60*1000);
                ...
                for(int i = 0 ; i < strs.length ; i++){
                    ...
                    if(strs[i].contains("packet loss")){
                        ...
                        if(!data.equals("0%")){
                            ...
                            pingProcess.fileOutputStream.write(log.getBytes("gbk"));
