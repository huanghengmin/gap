...
import com.hzih.gap.entity.NetInfo;
import com.hzih.gap.utils.GetListNetInfo;
...
//        System.out.println(linuxUtil.getMem());
        int num = 0;
        //while(true){
            //System.out.println("第 "+(num+1)+" 次重启网闸");
            //System.out.println(linuxUtil.getLinuxByCommand("192.168.1.87", "root", "admin","reboot"));
            System.out.println(linuxUtil.getLinuxByCommand("192.168.1.87", "root", "admin","ping 1.1.1.1 -f"));
            //System.out.println(linuxUtil.getLinuxByCommand("192.168.1.86", "root", "admin","ping 192.168.1.114 -f"));
        //}
