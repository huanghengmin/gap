...
//    SimpleDateFormat frm = new SimpleDateFormat("k:mm");
    ...
    JFreeChart jfreechart3 = ChartFactory.createTimeSeriesChart("Net Flux", "time", "flux mb/second", xydataset3, true, true, true);
...
//    rangeAxis.setAutoRange(true);
    ...
    jfreechart3.getTitle().setFont(new Font("宋体",Font.BOLD,15));//设置标题字体
