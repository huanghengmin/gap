...
<%
    ...
    File file = new File(System.getProperty("ichange.home")+File.separator+"tomcat"+File.separator+"temp");
...
//    rangeAxis.setAutoRange(true);
    ...
    jfreechart2.getTitle().setFont(new Font("宋体",Font.BOLD,15));//设置标题字体
...
//    rangeAxis.setAutoRange(true);
    ...
    jfreechartMem.getTitle().setFont(new Font("宋体",Font.BOLD,15));//设置标题字体
