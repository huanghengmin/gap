...
<body>
    <img src="<%= graphURL %>" width=500 height=360 border=0 bgcolor ="#FFFFFF"> </br></br>
    <img src="<%= graphURL2 %>" width=500 height=360 border=0 > </br></br>
    <img src="<%= graphURLMem %>" width=500 height=360 border=0 >

    <form name="myform" method="post" action="monitor_equipment_info.jsp">
