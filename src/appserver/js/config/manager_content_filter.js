...
//    Ext.QuickTips.init();
    ...
    var colM = new Ext.grid.ColumnModel([
        boxM,
        rowNumber,
        {menuDisabled : true, sortable:true, header:"<div style='text-align:center'>过滤内容</div>",	dataIndex:"filter", align:'left'  },
        {menuDisabled : true, header:'操作标记',			dataIndex:'id',					align:'center',		renderer: showURL_flag,width:70}
