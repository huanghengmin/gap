...
//       external_boxM,
       ...
       {header:'数据表集合',			dataIndex:'tables',		align:'center',menuDisabled:true,sortable:true,		renderer:external_showURL_tables,       width:90},
       {header:'源、目标',			dataIndex:'plugin',		align:'center',menuDisabled:true,sortable:true,		renderer:external_showURL_plugin},
...
//       external_allow_boxM,
       ...
       {header:'传输频率(秒)',		dataIndex:'interval',	align:'center',sortable:true},
       {header:'启用数据表',		dataIndex:'enable',		align:'center',sortable:true,		renderer:show_is},
       {header:'数据表集合',			dataIndex:'tables',		align:'center',menuDisabled:true,sortable:true,		renderer:external_allow_showURL_tables,       width:90},
