        ...
        items:[
            new Ext.form.FieldSet({
                ...
                items:[
                    ...
                    {
                        fieldLabel:"账户锁定策略（登录最多失败次数）",xtype:"textfield",
...
//                    {xtype:"checkbox",boxLabel:"启用远程登录限制",id:"remoteDisabled",name:"remoteDisabled"},
                    {
                        ...
                        items:[{
                            ...
                            columnWidth:.2,
                            items:[{
                                xtype:"checkbox",boxLabel:"启用管理员证书认证",id:"crtDisabled",
                                name:"crtDisabled",
                                listeners:{
                                    check:function(){
                                        var value = this.getValue();
                                        if(value){
                                            Ext.getCmp('check.info2').show();
                                        } else {
                                            Ext.getCmp('check.info2').hide();
                                        }
                                    }
                                }
                            }]
                            ...
                            items:[{
                                xtype:'displayfield',
                                value:'<font color="green">选中后表示用户登陆时会校验管理员证书!</font>'
                            }]
                        }]
