...
Ext.onReady(function() {
    ...
    var colM = new Ext.grid.ColumnModel([
        ...
        {header:"业务编号",			dataIndex:"businessName",  align:'center',sortable:true,menuDisabled:true,width:100},
        {header:'业务名',	    dataIndex:'businessDesc',  align:'center',sortable:true,menuDisabled:true},
