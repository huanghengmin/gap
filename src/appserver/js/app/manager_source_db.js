...
//       external_boxM,
       external_rowNumber,
       {header:"应用编号",			dataIndex:"appName",	    align:'center',sortable:true,menuDisabled:true},
       {header:"应用名",			    dataIndex:"appDesc",     align:'center',sortable:true,menuDisabled:true},
       {header:'应用类型',			dataIndex:'appType',	    align:'center',sortable:true,menuDisabled:true},
       {header:'通道',			dataIndex:'channel',	    align:'center',sortable:true,menuDisabled:true,       renderer:showURL_channel},
       {header:'通道端口',			dataIndex:'channelport',	align:'center',sortable:true,menuDisabled:true,          width:50},
       {header:'启用状态',			dataIndex:'isActive',	align:'center',sortable:true,menuDisabled:true,    	renderer:showURL_isActive},
       {header:'数据源',				dataIndex:'dbName',		align:'center',sortable:true,menuDisabled:true},
       {header:'同步方式',			dataIndex:'operation',	align:'center',sortable:true,menuDisabled:true,    	renderer:external_showURL_operation},
       ...
       {header:'源、目标',			dataIndex:'plugin',		align:'center',sortable:true,menuDisabled:true,		renderer:external_showURL_plugin},
       {header:'操作标记',			dataIndex:'flag',		    align:'center',sortable:true,menuDisabled:true,   	renderer:external_showURL_flag,    		width:250}
   ]);
