                            ...
                            success:function(action){
                                ...
                                if(json.msg != '0000'){
                                    Ext.MessageBox.show({
                                        ...
                                        fn:function(e){
                                            if(e=='ok'){
                                                Ext.getCmp('internal.appDesc.info').setValue('');
                                            }
                                        }
                                    });
                                }
                                    ...
                                    success:function(action){
                                        ...
                                        if(json.msg != '0000'){
                                            Ext.MessageBox.show({
                                                ...
                                                msg:'<font color="red">'+json.msg+'</font>',
                                                prompt:false,
                                                animEl:'internal.appDesc.update.info',
                                                width:200,
                                                buttons:{'ok':'确定'},
                                                icon:Ext.MessageBox.ERROR,
                                                closable:false,
                                                fn:function(e){
                                                    if(e=='ok'){
                                                        Ext.getCmp('internal.appDesc.update.info').setValue('');
                                                    }
                                                }
                                            });
                                        }
