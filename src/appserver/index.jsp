            ...
            <script type="text/javascript">
                ...
                Ext.onReady(function() {
                 ...
                 /*   var menu_root_node_10 = new Ext.tree.TreeNode({
                   ...
                   /* var mrn_2_5 = new Ext.tree.TreeNode({
                        id: 'mrn_2_5',
                        text: 'IPMAC绑定与探测',
                        leaf: true ,
                        url: 'pages/net/manager_ipmac_bond.jsp'
                    }) ;*/
//                    var mrn_2_6 = new Ext.tree.TreeNode({
//                        id: 'mrn_2_6',
//                        text: 'IPMAC探测',
//                        leaf: true ,
//                        url:'pages/net/manager_ipmac_probe.jsp'
//                    }) ;
                    ...
                    <%--<lbs:access code="SECOND_AQCL">
                    menu_root_node_2.appendChild(mrn_2_5) ;
                    </lbs:access>--%>
                    <%--<lbs:access code="SECOND_AQCL">--%>
                    <%--menu_root_node_2.appendChild(mrn_2_6) ;--%>
                    <%--</lbs:access>--%>
                    ...
                    var mrn_3_14 = new Ext.tree.TreeNode({
                        id: 'mrn_3_14',
                        text: '服务管理',
                        leaf: true ,
                        url: 'pages/system/manager_service.jsp'
                    }) ;
                    var mrn_3_15 = new Ext.tree.TreeNode({
                        id: 'mrn_3_15',
                        text: '通道测试',
                        leaf: true ,
                        url: 'pages/system/manager_init.jsp'
                    }) ;
                    var mrn_3_16 = new Ext.tree.TreeNode({
                        id: 'mrn_3_16',
                        text: '平台初始化',
                        leaf: true ,
                    ...
                    <lbs:access code="SECOND_INIT_S">
                    menu_root_node_3.appendChild(mrn_3_14) ;
                    </lbs:access>
                    ...
                    <lbs:access code="SECOND_TDPZ">
                    menu_root_node_3.appendChild(mrn_3_15) ;
                    </lbs:access>
                    <lbs:access code="SECOND_TDPZ">
                    menu_root_node_3.appendChild(mrn_3_16) ;
                    </lbs:access>
                    ...
                    var mrn_7_2 = new Ext.tree.TreeNode({
                        ...
                        text: '设备运行监控',
                        leaf: true ,
                        url: 'pages/zhexiantu/myfreezhexian.jsp'
                    }) ;
                    ...
                    var mrn_8_1 = new Ext.tree.TreeNode({
                        ...
                        text: '端口配置',
                        leaf: true ,
                        url: 'pages/port/port.jsp'
                    }) ;
                    /*var mrn_8_2 = new Ext.tree.TreeNode({
                        id: 'mrn_8_2',
                        text: 'TCP客户端',
                        leaf: true ,
                        url: 'pages/tcp/TCPClient.jsp'
                    }) ;
                    var mrn_8_3 = new Ext.tree.TreeNode({
                        id: 'mrn_8_3',
                        text: 'TCP访问控制',
                        leaf: true ,
                        url: 'pages/tcp/TCPControl.jsp'
                    }) ;*/
                    <lbs:access code="SECOND_TCPS">
                    menu_root_node_8.appendChild(mrn_8_1) ;
                    </lbs:access>
                    <%--<lbs:access code="SECOND_TCPC">
                    menu_root_node_8.appendChild(mrn_8_2) ;
                    </lbs:access>
                    <lbs:access code="SECOND_FWKZ">
                    ...
                    /*var mrn_9_1 = new Ext.tree.TreeNode({
                        ...
                        text: 'UDP服务端',
                        leaf: true ,
                        url: 'pages/udp/UDPServer.jsp'
                    }) ;
                    var mrn_9_2 = new Ext.tree.TreeNode({
                        id: 'mrn_9_2',
                        text: 'UDP客户端',
                        leaf: true ,
                        url: 'pages/udp/UDPClient.jsp'
                    }) ;
                    var mrn_9_3 = new Ext.tree.TreeNode({
                        id: 'mrn_9_3',
                        text: 'UDP访问控制',
                        leaf: true ,
                        url: 'pages/udp/UDPControl.jsp'
                    }) ;

                    <lbs:access code="SECOND_UDPS">
                    menu_root_node_9.appendChild(mrn_9_1) ;
                    </lbs:access>
                    <lbs:access code="SECOND_UDPC">
...
//                        contentEl : 'top-div',		//面板包含的内容
                    ...
                    centerPanel = new Ext.TabPanel({
                        ...
                        items: [{
                            ...
                            title: '设备运行监控',
                            leaf: true ,
                            html: '<iframe id="frame_mrn_7_2" width="100%" height="100%" frameborder="0" src="pages/zhexiantu/myjfreezhexian.jsp"></iframe>'
                        }]
                    });
